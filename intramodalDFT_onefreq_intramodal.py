...
def save_results_to_excel(results):
    ...
    df.to_excel("optimized_results_DFT_One_Frequency_Intramodal.xlsx", index=False)
    print("Results saved to 'optimized_results_DFT_One_Frequency_Intramodal.xlsx'.")
...
def plot_fidelity_vs_dimension():
    ...
    df = pd.read_excel("optimized_results_DFT_One_Frequency_Intramodal.xlsx")
